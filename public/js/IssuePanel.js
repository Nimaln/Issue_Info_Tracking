   ...
   // console.log('Value inside the class declration is:' + value)
    ...
    fetch('./readdataissue', {
        ...
        for (i = 0; i < res.length; i++) {
            issValue += (JSON.stringify(res[i].value) + ",");
            console.log(JSON.stringify(res[i].value))
        }

        div.innerText = issValue.split(',').join("\r\n"); 
...
// *******************************************
function IssueExtension(viewer, options) {
    Autodesk.Viewing.Extension.call(this, viewer, options);
    this.panel = null;
}

IssueExtension.prototype = Object.create(Autodesk.Viewing.Extension.prototype);
IssueExtension.prototype.constructor = IssueExtension;

IssueExtension.prototype.load = function () {
...
IssueExtension.prototype.onToolbarCreated = function () {
...
IssueExtension.prototype.createUI = function () {
    ...
    toolbarButtonShowDockingPanel.addClass('IssueToolbarButton');
    toolbarButtonShowDockingPanel.setToolTip('Issues');

    // SubToolbar
    this.subToolbar = new Autodesk.Viewing.UI.ControlGroup('IssueToolbar');
    this.subToolbar.addControl(toolbarButtonShowDockingPanel);

    viewer.toolbar.addControl(this.subToolbar);
};

IssueExtension.prototype.unload = function () {
